...
class ListItem extends React.Component {
    ...
    render() {
        ...
        if (this.props.restaurant.results.toUpperCase() === 'FAIL') {
            badge = RedBadge
        } else if (this.props.restaurant.results.toUpperCase() === "PASS") {
            badge = GreenBadge
        }
            ...
            <div className={containerClasses}>
                <div className="result-list-item">
                    <div className="result-list-item-description">
                        ...
                        <p className="result-list-item-last-updated">
                            Last Updated: {date.format('MMM D YYYY')}
                        </p>
                    </div>
